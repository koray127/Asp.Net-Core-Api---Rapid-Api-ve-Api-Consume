...
namespace HotelProjectWebUl.ValidationRules.GuestValidationRules
{
    public class CreateGuestValidator:AbstractValidator<CreateGuestDto>
    {
        public CreateGuestValidator()
        {
            ...
            RuleFor(x => x.Surname).MaximumLength(30).WithMessage("Lütfen fazla az 30 karakter veri girişi yapınız");
